...
<html lang="en">
  ...
  <meta name="request-id" content="EDAC:509A:752AE:9EEFA:5B7D20A2" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="ODc3MWMwMTA4Njk1MTlhNjU5Njg1YTgwYjhjYWJjZWQ0NmJmYzVlODUwOWRlODA4YzQxNzc5OGFmMDc3NDExZXx7InJlbW90ZV9hZGRyZXNzIjoiMjIyLjE4Mi4xODguMzgiLCJyZXF1ZXN0X2lkIjoiRURBQzo1MDlBOjc1MkFFOjlFRUZBOjVCN0QyMEEyIiwidGltZXN0YW1wIjoxNTM0OTI3MDI2LCJob3N0IjoiZ2l0aHViLmNvbSJ9">
  ...
  <meta name="html-safe-nonce" content="2ae1c916fe09099d3cbdbeb2d2c8803ad9afad8b">
...
>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="63557" data-scoped-search-url="/jquery/jquery-mousewheel/search" data-unscoped-search-url="/search" action="/jquery/jquery-mousewheel/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=Cym5uJWxW3or+hHz9e1l8dQf48Lg7fWIYneAMMMw5EDh2Jx5Xgln2Gh/QwQgnQw4/5WWkp/+37xxqTRpsI8vvA=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <span class="d-inline-block">
              <div class="HeaderNavlink px-0 py-2 m-0">
                <a class="text-bold text-white no-underline" href="/login?return_to=%2Fjquery%2Fjquery-mousewheel%2Fblob%2Fmaster%2Fjquery.mousewheel.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:control">Sign in</a>
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/jquery/jquery-mousewheel/stargazers"
      aria-label="3648 users starred this repository">
      3,648
    </a>
  ...
  <li>
    ...
    <a href="/jquery/jquery-mousewheel/network/members" class="social-count"
       aria-label="1513 users forked this repository">
      1,513
    </a>
  </li>
</ul>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <!-- blob contrib key: blob_contributors:v21:39185694af8990cd6b10a37bf8b47ba3 -->
      ...
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="W3U3lJCk9gtM9deGUKhD/Yxb2jhFhZ4epR4m7/Ab4pAp0YCvkJ51gDxn0XITxzW73Pwwr36H0zcJvwWJbDmskw==" />
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.26793s from unicorn-6b5896dff7-sthjg">GitHub</span>, Inc.</li>
