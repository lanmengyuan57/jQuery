...
<html lang="en">
  ...
  <meta name="request-id" content="EDAC:509A:74DF0:9E9DE:5B7D2096" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="ZTI4YjhkZDI0NDc2MDg1NzdhZWMxNzNlNTM2OGQ0YmMwODE0MTVjNTFhNWMyMzMyYWIyNDExOWYyYjU1ODlmNXx7InJlbW90ZV9hZGRyZXNzIjoiMjIyLjE4Mi4xODguMzgiLCJyZXF1ZXN0X2lkIjoiRURBQzo1MDlBOjc0REYwOjlFOURFOjVCN0QyMDk2IiwidGltZXN0YW1wIjoxNTM0OTI3MDEwLCJob3N0IjoiZ2l0aHViLmNvbSJ9">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="63557" data-scoped-search-url="/jquery/jquery-mousewheel/search" data-unscoped-search-url="/search" action="/jquery/jquery-mousewheel/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=9R7Jc7KfQonUKMvzBsoUx8noeItmQvlyvXNZSiMzbf4f7+yyeSd+K5etmQTTun0O4mIN2xlR00aure0TUIymAg=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <span class="d-inline-block">
              <div class="HeaderNavlink px-0 py-2 m-0">
                <a class="text-bold text-white no-underline" href="/login?return_to=%2Fjquery%2Fjquery-mousewheel%2Fblob%2Fmaster%2Fjquery.mousewheel.min.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:control">Sign in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <!-- blob contrib key: blob_contributors:v21:c1aea8cb64639d8b1cf68982076b7f68 -->
      ...
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="w+hbcEGMYxBRJoAPSegecckSKAtYnb5lS3JofEwp4MOxTOxLQbbgmyG0hvsKh2g3mbXCnGOf80zn00sa0AuuwA==" />
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.14755s from unicorn-1042801485-z43np">GitHub</span>, Inc.</li>
